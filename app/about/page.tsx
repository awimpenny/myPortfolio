    ...
    return (
        <main>
            ...
            <p className='text-left my-10 text-lg tracking-wide'>
                Hi, I'm Adam, a web developer passionate about crafting user-centric digital experiences. I specialize
                in creating efficient and responsive websites that merge form with function. Let's create something
                amazing together!
            </p>
            <div className='rounded-md italic p-5 bg-blue-500/20 text-md tracking-wide'>
                ...
                read-write; it's not just people consuming. It's not just people producing. It's people connecting, and
                we're still building it." - Tim Berners-Lee
            </div>
